...
const CartDropdown = () => {
  ...
  const { itemPrices, subtotal: dynamicSubtotal } = useCartPricing(
    cartState ?? null,
    regionCurrencyCode,
  )
          ...
          >
            <Surface variant="floating" className="overflow-hidden">
              ...
              {cartState && cartState.items?.length ? (
                <>
                  <div className="overflow-y-scroll max-h-100 px-4 py-3 grid grid-cols-1 gap-y-6 no-scrollbar">
                ...
                <div>
                  <div className="flex py-16 flex-col gap-y-4 items-center justify-center">
                    <div className="bg-ui-fg-base flex items-center justify-center w-6 h-6 rounded-full text-white">
                      <Text as="span" className="text-small-regular text-white">
                        0
                      </Text>
                    </div>
